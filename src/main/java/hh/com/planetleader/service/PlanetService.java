...
public class PlanetService {
    ...
    public void addPlanet(Planet planet) {this.planetRepository.save(planet);}
    public void deletePlanet(Planet planet) {this.planetRepository.delete(planet);}
    public void editPlanet(Planet planet) {this.planetRepository.save(planet);}
}
